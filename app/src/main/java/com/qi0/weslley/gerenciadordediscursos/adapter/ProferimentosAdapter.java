...
public class ProferimentosAdapter extends RecyclerView.Adapter<ProferimentosAdapter.MyViewHolder> {

    private List<Proferimento> proferimentoList;
    private List<Discurso> discursoList;
    private Context context;

    public ProferimentosAdapter(List<Proferimento> proferimentoList, List<Discurso> discursoList, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_proferimento, parent, false); //Todo Mudar o Layout

        return new ProferimentosAdapter.MyViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.dataProferimento.setText(proferimento.getDataProferimento());
